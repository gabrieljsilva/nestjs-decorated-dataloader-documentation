...
export function InstallationCode({ packageName, className }: InstallationCodeProps) {
  const { copied, copyToClipboard } = useClipboard();

  return (
    <div className={cn('relative rounded-lg border border-input bg-muted/50 p-6', className)}>
